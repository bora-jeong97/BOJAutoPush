	...
	public static void main(String args[]) throws Exception
	{
        ...
        for (int i = 1; i <= T; i++) {
            ...
            if (imm < 1 || imm > 12) {
                ...
                // System.out.println("해당 달은 : " + imm);
                // System.out.println("해당 일은 : " + idd);
                // System.out.println("days[imm] : " + days[imm]);

                // 2. 데이 검증
                if (idd < 1 || idd > days[imm]) {
                    System.out.printf("#%d -1%n", i);
                } else {
                    System.out.printf("#%d %s/%s/%s%n", i, yyyy, mm, dd);
                }
